...
Or use the Dockerfile! (must instal Docker first)
...
*Note, if you're using the Dockerfile on OSX with `boot2docker`, the URL
will be at the output of `boot2docker ip`, instead of `localhost:4567`.*
